ActionController::Routing::Routes.draw do |map|
  ...
  map.namespace :member do |member|
    member.resources :groups , :member => {:new_multiple => :get, :create_multiple => :post, :add_select => :get, :add => [:post,:get], :remove_select => :get, :remove => [:post, :get], :select_moderators => :get, :add_moderators => :post, :remove_moderator => :get, :edit_profiles => :get, :update_profiles => :post, :select_groups => :get, :add_groups => :get} do |group|
